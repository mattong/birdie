defmodule BirdieWeb.PostControllerTest do
  use BirdieWeb.ConnCase

  alias Birdie.Chirp

  @create_attrs %{content: "some content", timestamp: "2010-04-17 14:00:00.000000Z"}
  @update_attrs %{content: "some updated content", timestamp: "2011-05-18 15:01:01.000000Z"}
  @invalid_attrs %{content: nil, timestamp: nil}

  def fixture(:post) do
    {:ok, post} = Chirp.create_post(@create_attrs)
    post
  end
